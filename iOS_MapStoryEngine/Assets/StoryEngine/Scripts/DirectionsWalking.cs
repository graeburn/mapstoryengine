namespace Mapbox.Unity.MeshGeneration.Factories
{
	...
	// Offer user a real time walking route to each target site overlaid on the map
	public class DirectionsWalking : MonoBehaviour
	{
		[SerializeField]
		AbstractMap _map;
		...
		GameObject CreateGameObject(MeshData data)
		{
			...
			//_directionsGO.AddComponent<NavMeshSurface>();
